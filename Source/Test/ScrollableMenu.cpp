...
void ScrollableMenu::createListView()
{
    ...
    listView->setClippingType(ax::ui::Layout::ClippingType::SCISSOR);
    ...
    listView->addEventListener(AX_CALLBACK_2(ScrollableMenu::selectedItem, this));
    listView->setItemsMargin(DEFAULT_ITEM_MARGIN);
    addChild(listView);

}

void ScrollableMenu::selectedItem(ax::Ref *s, ui::ListView::EventType type)
{
    using namespace ax::ui;
