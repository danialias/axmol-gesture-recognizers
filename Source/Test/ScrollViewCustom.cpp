...
{
    //AXLOG("ScrollViewCustom::setInnerContainerSize");
...
{
    //AXLOG("ScrollViewCustom::doLayout");
    if (pinchRecognizer) {
...
void ScrollViewCustom::addPinchGestureRecognizer() 
{
    ...
    pinchRecognizer->onPinch = AX_CALLBACK_1(ScrollViewCustom::onPinch, this);
...
void ScrollViewCustom::addTapGestureRecognizer() 
{
    ...
    tapRecognizer->onTap = AX_CALLBACK_1(ScrollViewCustom::onTap, this);
